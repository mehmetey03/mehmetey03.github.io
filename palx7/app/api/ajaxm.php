...
if(isset($_GET['last_id'])){
    $last = base64_decode($_GET['last_id']);
}
...
for($i=0; count($arrx['title']) > $i; $i++) {
   ...
   <ion-item class="ion-item">
    <a id="<?=$arrx['data'][$i]?>" href="<?=$this->base_url?>MWatch/<?=base64_encode(PAL.$arrx['link'][$i]);?>">
     <div class="list">
